...
<html lang="en">
  ...
  <head>
    ...
    <title>iHome - ศูนย์รวมช่าง สถาปนิก - ผู้รับเหมา - วิศวกร</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top " id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">iHOME</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#contact">ติดต่อเรา</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        ...
        <h1>iHOME</h1>
        <hr class="star-light">
        <h2 class="font-weight-light mb-0">ศูนย์รวมช่าง - สถาปนิก - ผู้รับเหมา - วิศวกร</h2>
      </div>
    </header>
    ...
    <section class="bg-primary text-white mb-0" id="about">
      <div class="container">
        <h2 class="text-center text-uppercase text-white">เกี่ยวกับเรา</h2>
        <hr class="star-light mb-5">
        <div class="row">
          <div class="col-lg-4 ml-auto">
            <p class="lead">iHome เป็นเว็บไซต์ค้นหาช่าง สถาปนิก ผู้รับเหมา และผู้ให้บริการครบวงจรในวงการก่อสร้าง เป้าหมายเราคือ ยกระดับวงการรับเหมาก่อสร้างให้มีความน่าเชื่อถือกับผู้ว่าจ้าง และสร้างงานให้คนวงการ</p>
          </div>
          <div class="col-lg-4 mr-auto">
            <p class="lead">iHome เป็นเว็บไซต์ที่ทำให้คุณสามารถค้นหาผู้ให้บริการได้อย่างรวดเร็ว คุณมีโอกาสเปรียบเทียบผู้ให้บริการ หาราคาที่เหมาะสม และว่าจ้างผู้ให้บริการได้ทันทีผ่านเว็บแอพพลิเคชั่น</p>
          </div>
        </div>
    ...
    <section id="contact">
      <div class="container">
        <h2 class="text-center text-uppercase text-secondary mb-0">ติดต่อเรา</h2>
        <hr class="star-dark mb-5">
        <div class="row">
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container">
        <small>Copyright &copy; iHOME 2018</small>
      </div>
    </div>
